...
class EfficientNetBackbone(nn.Module):
    ...
    def __init__(self, variant='b1'):
        ...
        channels = [int(c * width_mult) for c in [16, 24, 40, 80, 112, 192, 320]]
    ...
    def forward(self, x):
        ...
        return features[-3:]  # Return last 3 feature maps
...
class OfflineEfficientDet(nn.Module):
    ...
    def __init__(self, num_classes=4, image_size=640, variant='d1'):
        ...
        # Get backbone output channels (simplified)
        backbone_channels = [40, 112, 320]  # Approximate for b1
